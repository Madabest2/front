...
export default function ServicesPage() {
  ...
  const featureBadges = [
    { icon: Medal, text: t("badge.experience") },
    { icon: Shield, text: t("badge.protection") },
    { icon: Smile, text: t("badge.satisfaction") },
  ];

  const cards = [
    {
      title: t("cards.hiking"),
      location: t("locations.nosybe"),
      rating: 5.0,
      rotation: 12.57,
      offsetX: 0,
      offsetY: 0,
    ...
    {
      title: t("cards.kayak"),
      location: t("locations.diegosuarez"),
      rating: 4.8,
      rotation: -9.32,
      offsetX: -30,
      offsetY: 0,
    ...
    {
      title: t("cards.cruise"),
      location: t("locations.antsohihy"),
      rating: 5.0,
      rotation: 4.18,
      offsetX: -60,
      offsetY: 0,
    ...
    {
      title: t("cards.wildlife"),
      location: t("locations.ambanja"),
      rating: 5.0,
      rotation: -11.64,
      offsetX: -90,
      offsetY: 0,
  ...
  const process = [
    {
      title: t("process.exchange"),
      desc: t("process.exchangeDesc"),
    },
    {
      title: t("process.organization"),
      desc: t("process.organizationDesc"),
    },
    {
      title: t("process.privileges"),
      desc: t("process.privilegesDesc"),
    },
    {
      title: t("process.groupImportance"),
      desc: t("process.groupImportanceDesc"),
    },
    {
      title: t("process.toKnow"),
      desc: t("process.toKnowDesc"),
    },
  ];
  return (
      ...
      <main className="flex-1 pt-40">
        ...
        <section className="relative mx-auto mb-24 w-full px-0">
          ...
          <div className="mx-auto mt-20 max-w-3xl text-center">
            <h2 className="mb-4 text-2xl font-medium text-[#0D0D0D]">{t("adventures.title")}</h2>
            <p className="text-[20px] leading-[29px] text-[#0D0D0D]">{t("adventures.text")}</p>
          </div>
        </section>
