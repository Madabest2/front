...
export function ContactForm() {
  ...
  return (
    <div className="mx-auto w-full max-w-7xl px-4 py-10 font-(--font-poppins) md:py-12 lg:py-16">
      {/* Titre principal */}
      ...
      <div className="relative mx-auto w-full max-w-[1196px] overflow-hidden rounded-[10px] bg-white shadow-[0px_0px_60px_30px_rgba(0,0,0,0.03)] lg:h-[667px]">
        <div className="flex h-full flex-col md:flex-row">
          ...
          <div className="relative hidden h-[647px] w-[509px] shrink-0 self-center overflow-hidden rounded-l-[10px] bg-[#E2531F] text-white lg:-right-2 lg:block">
          ...
          <div className="relative flex-1 px-6 py-6 md:px-8 lg:px-10 lg:py-8">
